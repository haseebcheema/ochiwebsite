...
function About() {
  return (
    <div className='w-full bg-[#CDEA68] py-20 rounded-[1vw]'>
      ...
      <div className='flex justify-between pt-6 px-12'>
        <div className='flex flex-col gap-4'>
            ...
            <button type='button' className='flex gap-7 items-center w-fit rounded-full px-5 py-3 text-white bg-[#212121] text-[1vw] border border-[#3B3F2B] cursor-pointer hover:bg-black hover:text-white'>
                READ MORE <div className='w-2 h-2 bg-white rounded-full'></div></button>
        </div>
        <div>
